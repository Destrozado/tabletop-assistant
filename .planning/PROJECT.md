...
- **Existe un resumen de partida previo** de Marvel Champions (elaborado con otra IA), con la estructura completa: 1) Preparación, 2) Fase de los jugadores, 3) Fase del villano (4 pasos), 4) Fin de ronda y reglas clave. Sirve como borrador de contenido y como mapa del flujo, pero **el propio usuario sospecha que tiene errores**.
