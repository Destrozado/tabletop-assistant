...
3 pendientes en `.planning/todos/pending/`. El selector de módulos se implementó en la quick 260925-mpj y el usuario lo dio por bueno. El bug de la vida inicial en Experto quedó resuelto en la quick 260925-m2k.
