...
- 03.1-03 DECISION DEL USUARIO (2026-08-31): esperar al reinicio diario de cuota en vez de activar facturacion. Hay que ejecutar `npm run voice:generate` una vez al dia (10 clips/dia) hasta llegar a 37; faltan 28, ~3 sesiones.
